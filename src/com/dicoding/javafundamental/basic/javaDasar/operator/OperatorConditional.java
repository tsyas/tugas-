...
//anastasya sabrina 266021746623
public class OperatorConditional {
    public static void main(String[] args) {
        ...
        System.out.println("Hasil Operator OR pada syarat value == 3 dan anotheValue == 5 adalah" + result);
        System.out.println("Hasil Operator OR pada syart value != 3 dan anotherValue == 5 adalah" + anotherResult);
        System.out.println();
